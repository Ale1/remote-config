/*
 * Didnt write this, only made very minor modifications.
...
namespace Homa.RemoteConfig.Extensions
{
		...
		IDictionary<TKey, TValue>, IDictionary, ISerializationCallbackReceiver, IDeserializationCallback, ISerializable
	{
		...
		public Dictionary<TKey, TValue> CopyDictionary => new Dictionary<TKey, TValue>(m_dict);
